...
class PapersDataSource {
    ...
    private var immutabelPapers: [Paper] = []
    ...
    func indexPathForNewRandomPaper() -> NSIndexPath {
        let index = Int(arc4random_uniform(UInt32(immutabelPapers.count)))
        let paperToCopy = immutabelPapers[index]
